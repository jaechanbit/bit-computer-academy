...
export const courses: Course[] = [
  {
    ...
    target: "컴퓨터 기초부터 자격증 취득까지 차근차근 준비하고 싶은 분",
  ...
  },
  {
    ...
    target: "정보처리 분야 입문자 또는 관련 자격증을 준비하는 분",
  ...
  },
  {
    ...
    outcome: "반복 업무를 줄이고 사무 실무 처리 능력을 높일 수 있습니다.",
    duration: "상담 후 안내",
    schedule: "상담 후 안내",
    price: "상담 후 안내",
    capacity: "상담 후 안내",
  ...
  },
  {
    ...
    target: "디자인 입문자, 이미지 제작이 필요한 사용자",
  ...
  },
  {
    ...
    target: "그래픽 디자인 기초를 배우고 싶은 분",
    curriculum: ["벡터 그래픽 이해", "도형과 패스", "색상과 타이포그래피", "출력물 제작"],
    outcome: "로고, 안내문, 홍보물 등 기본 디자인 결과물을 만들 수 있습니다.",
    duration: "상담 후 안내",
    schedule: "상담 후 안내",
    price: "상담 후 안내",
    capacity: "상담 후 안내",
  ...
  },
  {
    ...
    target: "디자인 자격증과 그래픽 실무를 함께 준비하는 분",
  ...
  },
  {
    ...
    description: "기초 입력부터 함수, 정렬, 필터, 차트, 실무 문서 작성까지 업무 예제로 학습합니다.",
  ...
  },
  {
    ...
    target: "컴퓨터활용능력 1급 자격증을 준비하는 분",
    curriculum: ["필기 핵심 이론", "엑셀 실기", "액세스 실기", "기출 문제 풀이"],
    outcome: "컴퓨터활용능력 1급 시험에 필요한 핵심 기능과 문제 대응 감각을 익힐 수 있습니다.",
    duration: "상담 후 안내",
    schedule: "상담 후 안내",
    price: "상담 후 안내",
    capacity: "상담 후 안내",
  ...
  },
  {
    ...
    target: "문서 작성 기초와 자격증을 함께 준비하고 싶은 분",
  ...
  },
  {
    ...
    target: "국민내일배움카드로 사무 자격증을 준비하는 분",
    curriculum: ["ITQ 한글", "ITQ 엑셀", "ITQ 파워포인트", "기출 및 모의고사"],
    outcome: "여러 ITQ 과목을 한 번에 준비하며 사무 실무 능력을 함께 키울 수 있습니다.",
    duration: "상담 후 안내",
    schedule: "상담 후 안내",
